...
namespace TarodevController
{
    ...
    public class PlayerStats : ScriptableObject
    {
        ...
        // Movement
        [Header("Movement"), Space] public float GroundBaseSpeed = 9;
        ...
        // Jump
        [Header("Jump"), Space] public float AirBaseSpeed = 9;
    ...
    public class CharacterSize
    {
        ...
        [Range(0.1f, 50), Tooltip("The width of your collider")]
        public float Width = 0.6f;

        [Range(STEP_BUFFER, 30), Tooltip("Step height allows you to step over rough terrain like steps and rocks.")]
